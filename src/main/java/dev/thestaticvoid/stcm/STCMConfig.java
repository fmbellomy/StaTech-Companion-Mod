...
public final class STCMConfig {
    ...
    public final ModConfigSpec.ConfigValue<ProspectorDistanceMode> prospectorDistanceMode;
    ...
    private STCMConfig(ModConfigSpec.Builder builder){
        ...
        prospectorDistanceMode = builder.comment("What method the prospector should use for calculating the distance of an ore deposit").define("prospector_distance_mode", ProspectorDistanceMode.XYZ);
